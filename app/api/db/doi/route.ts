...
export async function POST(req: NextRequest) {
    ...
    const response = await sendRegistrationFinalEmail(body.id, body.email, body.name, body.workshopLink, body.workshopTitle, body.workshopDate, body.location, body.workshopType, body.paymentId, body.workshopId);
