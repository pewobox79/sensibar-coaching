...
const TreatmentListItem =(props:{title:string, createdAt:string, type: string, details: string, documentId: string})=>{
    ...
    const handleClick = ()=>{
        clientContext.setClientData({selectedClientDetails: {type: props.type, title: props.title, details: props.details, documentId: props.documentId}})
    }
