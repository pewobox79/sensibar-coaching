...
const WorkshopsOverview = ({workshops=[]}) => {
    ...
    const ListOfWorkshops =workshops.map((workshop:{ documentId: string,title: string, workshop_date:string, link:{href: string, target: string, label: string}, type: string, ws_status: string, contacts:[]}) =>{
