...
const WorkshopsOverview = ({workshops=[]}) => {
    ...
    const ListOfWorkshops =workshops.map((workshop:{ location: {city: string, street: string, streetNumber: string, zipCode: string, country: string}, documentId: string,title: string, format: string, workshop_date:string, workshopTimeStart: string, workshopTimeEnd:string, description: [] , link:{href: string, target: string, label: string}, type: string, ws_status: string, contacts:[]}) =>{
