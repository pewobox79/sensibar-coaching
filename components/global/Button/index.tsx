...
type ButtonType = {
    ...
    title?: "registrieren" | "speichern" | "anrufen" | "details"|"akzeptieren" | "bestätigen" |"schließen" | "login" |"neu" | "Kunde suchen" |"öffnen" |"absagen" |"einladen" |"neuer workshop" |"neuer Coachee" |"löschen" |"Start";
    type: "submit" | "button";
    action?:()=>void;
    href?: string;
